...
public final class ItemMessageSentBinding implements ViewBinding {
  ...
  private ItemMessageSentBinding(@NonNull FrameLayout rootView, @NonNull ImageView imageViewMessage,
  ...
  public static ItemMessageSentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMessageSentBinding((FrameLayout) rootView, imageViewMessage, textViewMessage);
    }
